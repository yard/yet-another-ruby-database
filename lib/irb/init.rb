...
#   	$Revision: 14230 $
#   	$Date: 2007-12-15 02:05:15 +0900 (Sat, 15 Dec 2007) $
...
VMS = [[true, 1, "127.0.0.1", 20000], [false, 2, "127.0.0.1", 19000]]

def ys1
  setup_yard [[1, 'c:/tmp/ys1/default.db', 'c:/tmp/ys1/']] + VMS
  start_yard
end

def ys2
  setup_yard [[2, 'c:/tmp/ys2/default.db', 'c:/tmp/ys2/']] + VMS
  start_yard
end