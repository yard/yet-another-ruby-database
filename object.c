/**********************************************************************
  ...
  $Author: akr $
  $Date: 2007-12-24 16:52:39 +0900 (Mon, 24 Dec 2007) $
...
Init_Object(void)
{
    ...
    rb_define_method(rb_cObject, "yard_saved?", rb_yard_saved_object, 0);
    
    rb_define_method(rb_cObject, "yard_id", rb_yard_id, 0);
    ...
    rb_define_method(rb_mKernel, "setup_yard", rb_yard_configure, 1);
    ...
    rb_define_method(rb_mKernel, "yfetch", rb_yard_fetch, 2);
